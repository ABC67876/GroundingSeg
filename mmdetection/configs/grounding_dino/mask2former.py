...
# load_from = "biomedbert/det/best_coco_bbox_mAP_epoch_11.pth"
# load_from = "biomedbert/seg_mixdata-auxtext-GPU0/epoch_5.pth"
load_from = 'new_biomedbert/det_GPU1/best_coco_bbox_mAP_epoch_13.pth'
...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        mean=[39.139, 39.139, 39.139],  # TODO
...
val_evaluator = dict(
    ...
    ann_file=_base_.adni35_data_root + "valid/annotations_without_background.json",
    seg_prefix=_base_.adni35_data_root + "valid/annotations_without_background/",
)
test_evaluator = dict(
    type="CocoPanopticMetric",
    ann_file=_base_.adni35_data_root + "test/annotations_without_background.json",
    seg_prefix=_base_.adni35_data_root + "test/annotations_without_background/",
)

max_epoch = 20

default_hooks = dict(
    checkpoint=dict(interval=1, max_keep_ckpts=5, save_best="auto", rule="greater"),

...
load_from = "/home/lihua/Desktop/projects/mmd/mmdetection/groundingdino_swint_ogc_mmdet-822d7e9d.pth"
# load_from = "/home/lihua/Desktop/projects/mmd/mmdetection/adni_33/latest_model_weights.pth"
...
model = dict(
    ...
    bbox_head=dict(
        ...
        contrastive_cfg=dict(max_text_len=256, log_scale=0.0, bias=False),  # 256
        loss_cls=dict(

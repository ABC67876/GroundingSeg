# totally identical to grounding_dino_swin-t_finetune_16xb2_1x_coco.py
# except that:
# 1.dataset is coco panoptic
# 2.RandomFlip disabled
...
train_pipeline = [
    ...
    dict(
        type="LoadPanopticAnnotations", backend_args=_base_.backend_args

        ...
        **kwargs,
        ...
        if is_detection:  # 使用我修改之前的代码
            inter_states, references = self.decoder(
                ...
                return_position_dict=False,
                **kwargs,
            )
            # query.shape torch.Size([8, 1092, 256])
        ...
        inter_states, references, deformable_positions_dict = self.decoder(
            query=query,
            value=memory,
            key_padding_mask=memory_mask,
            self_attn_mask=dn_mask,
        ...
        return decoder_outputs_dict, deformable_positions_dict

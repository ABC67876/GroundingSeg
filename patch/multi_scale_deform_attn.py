...
class MultiScaleDeformableAttention(BaseModule):
    ...
    def forward(self,
        ...
        if return_position_dict:
            ...
            deformable_positions_dict["attention_weights"]=attention_weights
            deformable_positions_dict["sampling_locations"]=sampling_locations
            deformable_positions_dict["level_start_index"]=level_start_index
            deformable_positions_dict["spatial_shapes"]=spatial_shapes
            deformable_positions_dict["src_proj"]=value
            return self.dropout(output) + identity, deformable_positions_dict
